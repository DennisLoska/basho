function ChartSVG(id: string, colorVar: string, gradientId: string) {
  return (
    <svg class="w-full h-16" id={`${id}-chart`} viewBox="0 0 145 45" preserveAspectRatio="none">
      ...
      <line x1="22" y1="3" x2="22" y2="40" stroke="var(--color-base-content)" stroke-opacity="0.12" stroke-width="1" />
      <line x1="22" y1="21.5" x2="143" y2="21.5" stroke="var(--color-base-content)" stroke-opacity="0.08" stroke-width="0.5" stroke-dasharray="2,2" />
      <line x1="22" y1="40" x2="143" y2="40" stroke="var(--color-base-content)" stroke-opacity="0.12" stroke-width="0.5" />
      <text id={`${id}-yl-0`} x="20" y="6" text-anchor="end" fill="var(--color-base-content)" fill-opacity="0.25" font-size="3.5" font-family="monospace">100</text>
      <text id={`${id}-yl-1`} x="20" y="24.5" text-anchor="end" fill="var(--color-base-content)" fill-opacity="0.25" font-size="3.5" font-family="monospace">50</text>
      <text id={`${id}-yl-2`} x="20" y="43" text-anchor="end" fill="var(--color-base-content)" fill-opacity="0.25" font-size="3.5" font-family="monospace">0</text>
        ...
        <div class="card-body">
          ...
          <div id="gpu-info">
            ...
            <div class="flex flex-wrap gap-3 text-sm text-base-content/60 mt-1">
              <span><span id="gpu-temp">--</span>°C</span>
              <span>&middot; Util</span>
              <span id="gpu-fan" class="hidden">Fan: <span id="gpu-fan-speed">--</span>%</span>
            </div>
